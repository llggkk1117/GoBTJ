...
import org.gene.modules.randomString.RandomString;
...
public class SQLExecutor
{
	...
	public synchronized void openSession() throws ClassNotFoundException, SQLException, InterruptedException
	{
	 ...
	 * @throws SQLException
	 */
	private synchronized List<String[]> executeSelectSqlSaveToMemory(final String sql) throws SQLException
	{
	...
	private synchronized String executeSelectSqlSaveToFile(final String sql) throws IOException, InterruptedException, SQLException
	{
		...
		TextFile resultDataFile = TextFile.getInstance(resultDataFileName);
