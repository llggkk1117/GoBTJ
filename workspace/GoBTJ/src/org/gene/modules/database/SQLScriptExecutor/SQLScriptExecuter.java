...
public class SQLScriptExecuter
{
	...
	public synchronized void openSession() throws SQLException, InterruptedException, ClassNotFoundException
	{
		//Dependency
		if(this.connectionPoolAdaptor == null)
		{
			throw new IllegalArgumentException("connectionPoolAdaptor is null");
		}
	...
	public synchronized void execute(final String scriptFileName) throws IOException, InterruptedException, SQLException
	{
	...
	private static synchronized void execute(final String scriptFileName, final DBConnection dbConnection) throws IOException, InterruptedException, SQLException
	{
		TextFile scriptFile = TextFile.getInstance(scriptFileName);
	...
	public static synchronized String[] parse(String scriptFileName, boolean toFile) throws IOException, InterruptedException, SQLException
	{
		TextFile scriptFile = TextFile.getInstance(scriptFileName);
		boolean commentOn = false;
		String tempLine = null;
		...
		TextFile fileForSQLs = TextFile.getInstance(fileForSQLsName);
		fileForSQLs.clear();
