package com.gene.modules.randomString;
...
//		SPECIAL += SPECIAL_2;
	...
	{
		Check.notBlankWithMessage(IllegalArgumentException.class, charSet);
	...
	{
		Check.notBlankWithMessage(IllegalArgumentException.class, newCharSet);
